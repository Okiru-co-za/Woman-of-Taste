...
<p style="font-family:Arial,sans-serif;font-size:15px;color:#3a2e20;line-height:1.8">We are delighted to confirm your place at <strong>High Tea at Buitengeluk</strong> on 19 September 2026.</p>
...
<p style="font-family:Arial,sans-serif;font-size:14px;color:#7a6a54">With warmth,<br><strong>Patience Bwanya (PashieB)</strong><br>Woman of Taste</p>`,
    ...
    waitlisted: {
      ...
      body: `<p style="font-family:Arial,sans-serif;font-size:15px;color:#3a2e20;line-height:1.8">Dear <strong>${name}</strong>,</p>
<p style="font-family:Arial,sans-serif;font-size:15px;color:#3a2e20;line-height:1.8">Thank you for applying. We have added you to the waitlist for the <strong>High Tea at Buitengeluk</strong> on 19 September 2026.</p>
